...
import org.portalser.sistrad.business.MemberBC;
...
public class MemberService {
	...
	public Member lookupMemberById(@PathParam("id") long id) {
		Member member = memberBc.load(id);
		if (member == null) {
	...
	public boolean emailAlreadyExists(String email) {
		Member member = null;
		try {
			member = memberBc.findByEmail(email);
